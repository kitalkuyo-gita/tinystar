...
class AIService:
    ...
    async def batch_evaluate_topic_quality(self, topics: List[Dict[str, str]], existing_topics: List[Dict[str, str]] = None) -> List[Dict[str, str]]:
        ...
        system_prompt = (
            ...
            "例如：[{\"index\": 0, \"valid\": true, \"reason\": \"符合省级以上影响...\"}, {\"index\": 1, \"valid\": false, \"reason\": \"地方性日常事务...\"}]"
        )
...
2. **优先高热度**：新闻标题前标注了 [热度:数值]，请优先聚合那些**热度高、报道量大**的事件。忽略低热度或琐碎的新闻。
